  ...
  function MoreInfo() {
    if (document.querySelector(".defaultInfo").style.display !== "none") {
      ...
      tl_info.fromTo(
        ...
        { y: 0, opacity: 1, display: "block", duration: 0.4 }
      );
    } else {
      ...
      tl_info.fromTo(
        ".defaultInfo",
        { y: 40, opacity: 0, display: "none" },
        { y: 0, opacity: 1, display: "flex", duration: 0.4 }
      );
    }
  }
      ...
      <div className="Section5_Contacts">
        <div>
          ...
          <div className="articles_S5">
            ...
            <p className="pCaption__s5">
              ...
              <br /> We will be delighted to meet you!
            </p>
        ...
        <div className="Info">
          ...
          <div className="defaultInfo">
            ...
            <a
              href="mailto:info.callistostudio@gmail.com"
              target="_blank"
              className="email"
            >
              <p>EMAIL</p>
              <p>info.callistostudio@gmail.com</p>
            </a>
            <div className="socials"></div>
          </div>

          <div className="altInfo"></div>
        </div>
      </div>
    </div>
  );
